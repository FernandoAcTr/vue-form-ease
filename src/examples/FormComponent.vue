<template>
  <div>
    ...
    <p class="mb-3">
      The library includes a form component that you can use to manage your form. It manages for you the loading state,
      the prevent default, and the validation of the form.
    </p>
